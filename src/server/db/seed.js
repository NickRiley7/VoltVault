    ...
    const itemsToCreate = [
      {
        ...
        price: 1199.99,
        details:
          'Experience the ultimate iPhone with the iPhone 15 Pro Max. Choose between a 6.7" or 6.1" Super Retina XDR display featuring ProMotion technology and an Always-On display. The device boasts a sleek Titanium design with a textured matte glass back and an innovative Action button. Powered by the A17 Pro chip with a 6-core GPU, enjoy a magical interaction with the Dynamic Island feature. Capture stunning photos with the Pro camera system, including a 48MP Main, Ultra Wide, and Telephoto lens. Emergency SOS, Crash Detection, and Roadside Assistance via satellite provide added safety features. With up to 29 hours of video playback, USB‑C support, and Face ID, the iPhone 15 Pro Max is the epitome of cutting-edge technology.',
      ...
      },
      {
        ...
        price: 899.99,
        details:
          "Experience sleek, thin, and ultra-light productivity with the Microsoft Surface 5. Choose between a 13.5” PixelSense™ touchscreen for ultra-portable use or a larger 15” display for split-screen multitasking. Weighing just 2.80 lbs, it boasts a comfortable keyboard and is available in warm Alcantara® or cool metal finishes with bold colors like Sage. Powered by snappy 12th Gen Intel® Core™ i5/i7 processors on the Intel® Evo™ platform, it ensures blazing fast performance. Enjoy lightning-fast Thunderbolt™ 4 for 4K connectivity and efficient data transfer. With Studio Mics, enhanced camera experiences, Dolby Vision IQ™, and Dolby Atmos®, elevate your calls and cinematic entertainment. Windows Hello and Windows 11 security provide peace of mind, while Microsoft 365, ClipChamp video editing, and secured OneDrive storage enhance productivity. Play together with Xbox Game Pass Ultimate on Windows PCs. The Microsoft Surface 5 is the epitome of style, performance, and security.",
      ...
      },
      {
        ...
        price: 1799.99,
        details:
          "Experience the future of mobile technology with the Galaxy Z Fold5. Unfold the massive 7.6'' cinematic screen for an immersive streaming experience on the go. Elevate your gaming with a powerful device, high refresh rates, and minimal input delays. Dual-App Viewing lets you do more with the expansive display, and S Pen capability enhances precision and productivity. Enjoy two experiences in one with the 6.2'' cover display and 7.6'' interior screen. Put it in Flex Mode for hands-free video calling or watching content. The sleek design, three unique colors, and durable build with Gorilla Glass Victus and IPX8 water resistance make the Galaxy Z Fold5 a head-turning device. Sync your world and simplify your life with connected Galaxy features like Quick Share and Galaxy Watch integration.",
      ...
      },
      {
        ...
        price: 1999.99,
        details:
          "Unleash gaming excellence with the Alienware Aurora R16 Gaming Desktop. Powered by a 13th Gen Intel® Core™ i7-13700F 16-Core processor, experience incredible performance up to 5.2 GHz with Turbo Max 3.0. Running Windows 11 Home (Dell recommends Windows 11 Pro for business), it's designed for immersive gaming. The NVIDIA® GeForce RTX™ 4070 with 12GB GDDR6X ensures stunning graphics. Enjoy smooth gameplay with 32 GB DDR5 memory at 5600 MT/s and a lightning-fast 1TB PCIe NVMe SSD. The desktop is equipped with a 500W Platinum Rated PSU, 240mm Liquid-Cooled CPU, and a clear side panel for an impressive visual experience. Elevate your gaming setup with the Alienware Aurora R16.",
      ...
      },
      {
        ...
        price: 2499.0,
        details:
          'Experience unparalleled performance with the XPS 17 Laptop. Powered by a 13th Gen Intel® Core™ i7 processor, NVIDIA® GeForce RTX™ 4070 graphics, and a stunning 17" UHD+ touch display, this laptop delivers breathtaking visuals and powerful computing. With 32GB DDR5 memory and a 1TB PCIe NVMe SSD, multitasking and storage are lightning-fast. The sleek Platinum Silver exterior and Black interior showcase a premium CNC machined aluminum and carbon fiber construction. Enjoy studio-quality audio with Waves MaxxAudio® Pro and Waves Nx® 3D audio through the quad-speaker design. Stay connected with Intel® Killer™ Wi-Fi 6, and work worry-free with McAfee® Business Protection and ProSupport service. The backlit keyboard with a fingerprint reader adds convenience, and the laptop is equipped with a variety of ports, including Thunderbolt™ 4. The XPS 17 is designed for professionals who demand power, performance, and portability.',
